...
# Sorting Quadrilaterals: Identifying Rhombuses, Rectangles, Squares, and Other Quadrilaterals

## Learning Objective
Students will be able to sort and draw quadrilaterals by identifying shared attributes (such as four sides, pairs of parallel sides, and equal side lengths) and will correctly recognize rhombuses, rectangles, and squares as examples of quadrilaterals while producing examples of quadrilaterals that do not fit those subcategories.

---

## Assessment
Give students a mixed packet of 12 shapes (printed or projected)—including several rhombuses, rectangles, squares, parallelograms that are not rectangles, kites, trapezoids, and irregular quadrilaterals. Students must:

1. Sort the shapes into two groups:  
   - (A) Quadrilaterals that are rhombuses, rectangles, or squares  
...
- Mini-lesson (5 min): Define quadrilateral and show a labeled example.  
...
Monitor performance and record misconceptions.
...
## Extension Activity
- Geometry Challenge: Students who finish early design a “quadrilateral creature” using three different quadrilaterals. Label parts and write a paragraph explaining why each part fits its category.

---

## Homework
- Family Math Project: Find/photograph or draw three quadrilaterals at home. Identify if rectangle, rhombus, square, or other. Write one sentence for each explaining the attributes used.
...
| Criterion | Score (1–5) | Notes / Evidence |
|-----------|------------:|----------------|
| Standards Alignment | 5 | Lesson directly addresses CCSS.Math.Content.3.G.A.1 |
| Content Accuracy | 5 | Definitions, examples, and explanations are correct. Quadrilateral types are accurately described. |
| Age-Appropriate Language | 5 | Vocabulary and sentence complexity suitable for 3rd graders. |
| Differentiation / Scaffolds | 3 | There are two different suggestions for extension but the scaffold for struggling students is more for drawing support than learning support. |
| Engagement / Instructional Quality | 5 | The lesson contains a variety of direct instruction, partner work, independent work, and drawing. This would keep students with short attention spans engaged with a variety of activities. |
| Assessment / Checks for Understanding | 4 | The lesson provides a mix of informal/formal assessment. However, the exit ticket tests the most challenging part of this standard (what doesn’t fit into these subgroups) and many 3rd graders will be unable to answer this question at the end of the first lesson on shapes. |
| Feasibility / Classroom Usability | 2 | Most students will not be able to go through the whole range of understanding to complete all activities in this lesson in one day. |
| Teacher Notes / Anticipated Misconceptions | 2 | The suggestion for anticipated misconceptions is not the most likely misconception. Most students struggle to understand how a shape can fit into more than one category (rectangle and square). |
| Time Estimate Realism | 3 | I think this lesson has too many activities for an hour-long lesson and would be best split into two days. |
| Materials Completeness | 1 | It would be helpful to have a clear list of materials needed. |
